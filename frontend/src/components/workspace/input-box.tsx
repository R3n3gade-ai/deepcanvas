      ...
      >
        ...
        <PromptInputFooter className="flex">
          ...
          <PromptInputActionMenu>
            ...
            {/* Plan Mode Toggle */}
            <Tooltip content={context.plan_mode !== false ? "Plan Mode: On" : "Plan Mode: Off"}>
              <button
                type="button"
                onClick={() => {
                  onContextChange?.({
                    ...context,
                    plan_mode: context.plan_mode === false ? true : false,
                  });
                }}
                className={cn(
                  "flex items-center gap-1 rounded-md px-2 py-1 text-xs font-normal transition-colors",
        ...
        {isNewThread && searchParams.get("mode") !== "skill" && (
          <div className="absolute right-0 -bottom-4 left-0 z-0" />
        )}
        {!isNewThread && (
